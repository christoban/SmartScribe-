...
# 🔧 CORRECTION FACULTATIVE : Configuration CORS sécurisée  
# En développement, on autorise tous les origins pour faciliter les tests  
# En production, on restreint aux domaines de confiance uniquement  
origins = ["*"] if settings.DEBUG else [  
    "http://localhost:3000",      # Frontend local (React/Next.js)  
    "http://127.0.0.1:3000",      # Variante localhost  
    "https://scolar-ai.com",      # Domaine de production (à adapter)  
