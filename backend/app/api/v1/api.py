...
from app.api.v1.routes import (  
    ...
    websocket,  
    health,  
    documents  # 🔧 AJOUT : Import du router documents  
)  
...
api_router.include_router(documents.router, prefix="/documents", tags=["Documents"])  # 🔧 AJOUT : Enregistrement du router documents  
